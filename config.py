...
APP_ID = int(os.environ.get("APP_ID", "17822592"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "a20b3dbbe07ed695563b4609a3e62012")

#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002169923037"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001767004641"))
